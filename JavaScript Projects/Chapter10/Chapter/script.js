...
function loadDirections(string) {
   ...
   //geoTest();
   // to minimize data use, downlaod map only if needed and not already downloaded
...
function startDrag(evt) {
	// set the z-index to move selected element on top of others
...
function removeTouchListener() {
	...
	this.removeTouchListener("mspointermove", moveDrag, false);
	this.removeTouchListener("pointermove", moveDrag, false);
	this.removeTouchListener("touchend", removeTouchListener, false);
	this.removeTouchListener("mspointerup", removeTouchListener, false);
	this.removeTouchListener("pointerup", removeTouchListener, false);
}
