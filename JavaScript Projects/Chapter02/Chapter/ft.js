 ...
 */
 ...
 //calculates all costs based on staff and adds to toal cost
 function calcStaff() {
 ...
 // adds/subtracts cost of memory book from the total cost
 ...
 // adds/subtracts cost of rights from the total cost
